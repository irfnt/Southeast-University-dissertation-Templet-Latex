\documentclass[algorithmlist, figurelist,tablelist, nomlist,phd, scheme = plain]{seuthesix}
\usepackage{lipsum}
\usepackage{ctex} 
...
\studentid{189919}   %学号要完整，前面的零不能省略。
\title{灵犀一指心法}{灵犀一指}{The theory of powerful fingers}{powerful fingers}
\author{陆小凤}{Alozno}
\advisor{夜帝}{教授}{Russle Arnold}{Prof.}
 % 没有% 可以不填
 \degreetype{武学博士}{Doctor of Communication Engineering} % 详细学位名称
\major{Communication \ Engineering}
\submajor{Communication \ Engineering}
\defenddate{\today}
\authorizedate{\today}
\committeechair{夜帝}
\reviewer{张三丰}{黄药师}
\department{东南大学武学院}{School of Information Science and Engineering}
...
\setnomname{List of Abberivations}
\tableofcontents
\listofothers
...
\section{Pulsar}
What is pulsar and how we dectected pulsar
...
\chapter{Machine learning and Deeplearning for pulsar classification}
